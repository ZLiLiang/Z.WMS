    ...
    public class BaseDAL<T> : BQuery<T> where T : class
    {
        ...
        public bool AddList(List<T> list, string strCols)
        {
            ...
            foreach (T t in list)
            {
                ...
                CommandInfo com = new CommandInfo(insert.Sql, insert.SqlParaArray, false);
                comList.Add(com);
            }
        ...
        public bool UpdateList(List<T> list, string strCols)
        {
            ...
            foreach (T t in list)
            {
                ...
                CommandInfo com = new CommandInfo(update.Sql, update.SqlParaArray, false);
                comList.Add(com);
            }
            return SqlHelper.ExecuteTrans(comList);
        }
        ...
        public bool DeleteList(List<int> idList, int actType, int isDeleted)
        {
            ...
            foreach (int id in idList)
            {
                ...
                CommandInfo com = new CommandInfo(delSql, paras, false);
                comList.Add(com);
            }
            return SqlHelper.ExecuteTrans(comList);
        }
